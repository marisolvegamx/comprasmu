 ...
 * Use the {@link NvaCorrecCalCajaFragmentnuevacaja#newInstance} factory method to
 * create an instance of this fragment.
 */
public class NvaCorrecCalCajaFragmentnuevacaja extends Fragment {
    ...
    public NvaCorrecCalCajaFragmentnuevacaja() {
     ...
     */
    public static NvaCorrecCalCajaFragmentnuevacaja newInstance(String param1, String param2) {
        NvaCorrecCalCajaFragmentnuevacaja fragment = new NvaCorrecCalCajaFragmentnuevacaja();
    ...
    public void crearFormulario(){
        ...
        if(isEdicion&&correccion!=null) {
            ...
            if(isEdicion) {
                inftemp=new InformeTemp();// en detalleinfview se usa informetemporal para obtener el valor que se edita
                //por eso creo un objeto para guardar el valor
                inftemp.setValor(nvoDet.getRuta_foto());
                preguntaview.setUltimares(inftemp);
                preguntaview.setEdicion(isEdicion);
            }
        }
    ...
    public void actualizarSolicitud() {
        try {
            ...
            InformeEtapaEnv envioinf=preViewModel.preparaInformeEtiq(mViewModel.getIdNuevo());
    ...
    public void iniciarLecQR(){
        IntentIntegrator integrator  =new  IntentIntegrator ( getActivity() ).forSupportFragment(NvaCorrecCalCajaFragmentnuevacaja.this);
