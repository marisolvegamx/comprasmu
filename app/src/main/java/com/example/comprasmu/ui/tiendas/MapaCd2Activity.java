...
public class MapaCd2Activity extends FragmentActivity implements
    ...
    class CustomInfoWindowAdapter implements InfoWindowAdapter {
        ...
        CustomInfoWindowAdapter() {
            mWindow = getLayoutInflater().inflate(R.layout.custum_info_window, null);
            mContents = getLayoutInflater().inflate(R.layout.custum_info_content, null);
        }
        ...
        private void render(Marker marker, View view) {
            ...
            if (marker.equals(mBrisbane)) {
                badge = R.drawable.ic_baseline_arrow_forward_ios_24;
