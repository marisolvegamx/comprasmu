...
public class DescargasIniAsyncTask extends AsyncTask<String, Void, Void> implements  DescRespInformesEta.ProgresoRespIEListener {
    ...
    public DescargasIniAsyncTask(Context act, CatalogoDetalleRepositoryImpl cdrepo,
        ...
        this.descargarNotificaciones=descargarNotificaciones;
    ...
    protected Void doInBackground(String... indice) {
        ...
        if(descargarNotificaciones){
            this.notificacionesGenerales(); //incluye las solicitudes de correccion, cancelaciones y notif generales
    ...
    private void getRespaldo(){
        ...
        Log.i("DescargasIniAsyncTask", "descargando respaldo inf");
