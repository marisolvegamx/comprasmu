...
*/
    ...
    @Query("SELECT * FROM informe_etapa WHERE   indice=:indice and (estatus=:estatus or estatus=5 or estatus=6) and etapa=:etapa and ciudadNombre=:ciudad order by id desc")
