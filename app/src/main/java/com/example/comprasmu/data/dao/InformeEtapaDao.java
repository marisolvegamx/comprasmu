...
*/
    ...
    //gastos puede estar en 2 o 6 o 7 (cerrado/ajustado/en revision)
    @Query("SELECT * FROM informe_etapa where etapa=:etapa and indice=:indice and (estatus=:estatus or estatus=6 or estatus=7)")
