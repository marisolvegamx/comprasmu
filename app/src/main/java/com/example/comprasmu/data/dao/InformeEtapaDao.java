...
public abstract class InformeEtapaDao extends  BaseDao<InformeEtapa>{
    ...
    @Query("SELECT * FROM informe_etapa where etapa=:etapa and indice=:indice and estatus>0")
    public abstract LiveData<List<InformeEtapa>> getInformesActivos(int etapa, String indice);
    ...
    public abstract List<InformeEtapa>  getInformePendSimpPrep(String indice, int etapa);
...
*/
    ...
    @Query("SELECT * FROM informe_etapa WHERE   indice=:indice and (estatus=:estatus or estatus=7) and etapa=:etapa and ciudadNombre=:ciudad order by id desc")
    ...
    @Query("SELECT * FROM informe_etapa WHERE  indice=:indice and (estatus=1 or estatus=5) and etapa=:etapa and ciudadNombre=:ciudad order by id desc")
    public abstract LiveData<List<InformeEtapa>>  getInformePendGas(String indice, int etapa, String ciudad);
    /****muestro informes gastos abiertos o para agregar gastos nvo estatus 5****/
    ...
    public abstract List<InformeEtapa>  getInfGasxEstatusCiu(String indice, int etapa, int estatus, String ciudad);
    ...
    @Query("SELECT * FROM informe_etapa where etapa=:etapa and indice=:indice and clientesId=:clienteid and ciudadNombre=:ciudadNombre and estatus=:estatus")
    public abstract List<InformeEtapa> getInformesxCliEst(int etapa, String indice, int clienteid, String ciudadNombre, int estatus);

    @Query("SELECT * FROM informe_etapa WHERE   indice=:indice and (estatus=:estatus1 or estatus=:estatus2) and etapa=:etapa order by id desc")
    public abstract LiveData<List<InformeEtapa>>  getInformesx2Estatus(String indice, int etapa, int estatus1, int estatus2);

    @Query("SELECT * FROM informe_etapa WHERE   indice=:indice and (estatus=:estatus1 or estatus=:estatus2) and etapa=:etapa order by id desc")
    public abstract List<InformeEtapa>  getInformesx2EstatusSimple(String indice, int etapa, int estatus1, int estatus2);
