...
public class DescargaCambiosImagenes {
        ...
        public DescargaCambiosImagenes(Context act,TablaVersionesRepImpl tablaVersionesRepo) {
            this.act=act;
        ...
        private void getCambios (){
            ...
            DescargaCambImgagenListener listener=new DescargaCambImgagenListener();
            String fecha="2025-01-01"; //para la 1era vez
            if(comp!=null&&!comp.getVersion().equals("")){
                fecha=sdfformat.format(comp.
            }
            //siempre actualizo
            ps.pedirCambiosImagenes(Constantes.INDICEACTUAL,null,Constantes.INDICEACTUAL,listener);
    ...
    public void pedirCorrecciones(int actualiza, int etapa) {
        ...
        if (NavigationDrawerActivity.isOnlineNet(this.act))
            ps.pedirSolicitudesCorr(Constantes.INDICEACTUAL, etapa, version, new DescargaCambImgagenListener());
        else
            notificar = true;
...
public class DescargaCambImgagenListener implements IDescargaIniListener, IActualListener {
