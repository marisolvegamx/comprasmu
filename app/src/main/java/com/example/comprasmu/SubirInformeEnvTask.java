...
public class SubirInformeEnvTask extends AsyncTask<String, Float, Integer> {

    public static String TAG = "SubirInfEtaTask";
    InformeEnvPaqEnv envio;
    Context context;
     ...
     */
    public SubirInformeEnvTask(InformeEnvPaqEnv envio, Context context) {
    ...
    public void enviarReporte() {
        ...
        if(NavigationDrawerActivity.isOnlineNet(context)) {
            ...
            postviewModel.sendInformeEnvio(envio);
